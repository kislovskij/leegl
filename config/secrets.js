...
module.exports = {
  ...
  mailgun: {
    ...
    password: process.env.MAILGUN_PASSWORD || '6akqd4ulfx-2'
  },
  ...
  google: {
    clientID: process.env.GOOGLE_ID || '610427950258-ns9h5bfbqt1sniocdnjrhei8dquo4p7g.apps.googleusercontent.com',
    clientSecret: process.env.GOOGLE_SECRET || 'Y9OZ-UEeVqk6RN5GqrGMPEig',
